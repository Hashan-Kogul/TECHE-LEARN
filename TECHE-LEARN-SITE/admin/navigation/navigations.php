...
<title>TECHE-LEARN ADMINISTRATORS</title>
...
<div class="navbar-header">
  ...
  <a class="navbar-brand"  href="<?php echo web_root; ?>admin/index.php" >TECHE-LEARN ADMINISTRATORS </a>
</div>
...
<div class="navbar-default sidebar" role="navigation">
        <div class="sidebar-nav navbar-collapse">
            ...
            <!--     <li>
                ...
                <li>
                     <a href="<?php echo web_root; ?>admin/modules/PastPaper/index.php"><i class="fa fa-user fa-fw"></i> Past Papers </a> 
                </li>
                 <li>
...
<section id="page-footer"> 
      <footer>  <p align="center">&copy; <b>TECHE-LEARN GROUP-24 <br> Developed By <br> Y.Hashan Kogul <br> L.W.L.S MADUSANKA </p></footer>
</section>
<!-- Plugins -->
