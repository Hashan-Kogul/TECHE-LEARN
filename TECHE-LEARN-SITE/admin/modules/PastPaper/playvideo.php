...
<style type="text/css">
 ...
 <div class="container" >
 	<video width="50%"  controls>
		  <source src="<?php echo web_root.'admin/modules/PastPaper/'.$res->FileLocation; ?>" type="video/mp4">
		  <source src="<?php echo web_root.'admin/modules/PastPaper/'.$res->FileLocation; ?>" type="video/ogg"> 
		</video>
